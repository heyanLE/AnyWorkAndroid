...
import com.qgstudio.anyworkc.notice.data.Message;
import com.qgstudio.anyworkc.notice.data.MessageFactory;
...
public class WebSocketHolder extends WebSocketListener {
    ...
    private static final String TAG = "WebSocketHolder";
